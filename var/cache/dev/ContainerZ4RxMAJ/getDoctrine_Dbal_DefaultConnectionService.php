...
return $this->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory(array()))->createConnection(array('driver' => $this->getEnv('DB_DRIVER_DEV'), 'charset' => $this->getEnv('DB_CHARSET_DEV'), 'memory' => false, 'url' => $this->getEnv('resolve:DATABASE_URL_DEV'), 'host' => 'localhost', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'driverOptions' => array(), 'serverVersion' => $this->getEnv('DB_VERSION_DEV'), 'defaultTableOptions' => array()), $c, $d, array());
