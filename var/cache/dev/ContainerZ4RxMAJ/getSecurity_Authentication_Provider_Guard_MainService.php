...
}, 1), ($this->privates['security.user.provider.concrete.database_users'] ?? $this->load('getSecurity_User_Provider_Concrete_DatabaseUsersService.php')), 'main', ($this->privates['security.user_checker'] ?? $this->privates['security.user_checker'] = new \Symfony\Component\Security\Core\User\UserChecker()));
