...
return $this->privates['App\Domain\Repository\CommentsRepository'] = new \App\Domain\Repository\CommentsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
