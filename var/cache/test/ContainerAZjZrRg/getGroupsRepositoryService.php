...
// Returns the private 'App\Domain\Repository\GroupsRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Domain/Repository/Interfaces/GroupsRepositoryInterface.php';
include_once $this->targetDirs[3].'/src/Domain/Repository/GroupsRepository.php';

return $this->privates['App\Domain\Repository\GroupsRepository'] = new \App\Domain\Repository\GroupsRepository(($this->services['doctrine'] ?? $this->load('getDoctrineService.php')));
