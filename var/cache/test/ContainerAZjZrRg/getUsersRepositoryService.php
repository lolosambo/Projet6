...
return $this->privates['App\Domain\Repository\UsersRepository'] = new \App\Domain\Repository\UsersRepository(($this->services['doctrine'] ?? $this->load('getDoctrineService.php')));
