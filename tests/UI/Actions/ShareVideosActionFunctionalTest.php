...
/**
 * Class ShareVideosActionFunctionalTest
 *
 * @author Laurent BERTON <lolosambo2@gmail.com>
 */
class ShareVideosActionFunctionalTest extends WebTestCase
{
    use TestCaseTrait;
    ...
    public function testGetStatusCode()
    {
        ...
        $client->request('POST', '/ajout-videos/5');
     ...
     * @group Blackfire
     */
    public function testShareVideosInvoke()
    {
